const translations = {
  en: {
    ...
    no_contacts_yet: 'There are no contacts yet. Add your first contact or invite friends to same.',
    no_subitems_yet: 'There are no trips, accommodations or activities yet. Push the plus to start.',
    no_favorites_yet: 'There are no favorites yet. Favor your contacts or find favorites via search.',
    feedback_better: 'How can we manage to improve same?',
...
E-Mail: info@same.to
Internetadresse: http://www.same.to
Register entry
Entry in Handelsregister
Register Number: HRB 24637
Register Court: Koblenz
...
NAME, EMAILADRESS, PROFIL-INFORMATIONS and so on...
is collected and stored solely for use by our website. When signing up for our website, we also store your IP address and the date and time you registered. This serves to protect us in the event a third party improperly and without your knowledge makes use of your data to sign up for our site. None of this information is transferred to third parties. Nor is any of this information matched to any information that may be collected by other components of our website.
  ...
  de: {
    ...
    event: 'Event',
    search: 'Suchen',
    search_contacts: 'Kontakte finden',
    ...
    limo: 'Limo',
    driver: 'Limo',
    from_location: 'Abfahrtsort',
    to_location: 'Ankunftsort',
    from: 'von',
    to: 'nach',
    date: 'Datum',
    make_trip_public: 'Trip öffentlich machen',
    make_event_public: 'Event öffentlich machen',
    ...
    all_accommodations: 'Alle Unterkünfte',
    all_trips: 'Alle Trips',
    save: 'Speichern',
    ...
    feedback_better: 'Was können wir an same verbessern?',
...
Website Impressum erstellt durch impressum-generator.de von der Kanzlei Hasselbach, Köln-Rodenkirchen`,
...
NAME, E-MAILADRESSE, PROFILINFORMATIONEN etc.
