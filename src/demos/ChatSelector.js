...
export default class ChatSelectorRow extends Component {
    ...
    render = () => {
        const { uriProfile, name, location, onSelected, rowId, onProfile, isSelected } = this.props;
        return (
            <View style={styles.container} >
                ...
                <TouchableOpacity style={styles.optionsContainer} onPress={() => onSelected(rowId)} >
                    {isSelected ?
                        <Image style={styles.iconOption} source={icTick} resizeMode={Image.resizeMode.contain} />
                        : null}
                </TouchableOpacity>
            </View>
        )
